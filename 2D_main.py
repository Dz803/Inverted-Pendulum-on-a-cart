...
def main():
    ...
    M, m, l, g, b, zeta, c = 0.28, 0.075, 0.32, 9.81, 0.04, 0.0, 0.015
    ...
    if args.controller == "pid":
        ...
        Q = np.diag([100,6,15,12])
        R = np.array([[100]])
        ctrl = DiscreteLQRController(Ad, Bd, Q, R, dt=dt, max_force=10.0, target_state=[0, 0, 0, 0])
    else:
